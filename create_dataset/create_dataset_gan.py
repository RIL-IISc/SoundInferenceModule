...
class Create_dataset_gan:
    ...
    def dataset(self):
        ...
        for sample, list_channel_file in groups.items():
            for audio_file in list_channel_file:
                ...
                audio_data[sample].append(spec_channel)
                #print(audio_file)
    ...
    def stacked_spectrogram(self):
        ...
        for s, list_channel_data in audio_data.items():
            #count += 1
            #print(s)
            stft_channel1 = list_channel_data[0]
            stft_channel2 = list_channel_data[1]
            stft_channel3 = list_channel_data[2]
            stft_channel4 = list_channel_data[3]
